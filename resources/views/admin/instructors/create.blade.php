    ...
    <div class="glass-card rounded-2xl p-6" id="instructor-form-fields"
        ...
        <form method="POST" action="{{ route('admin.instructors.store') }}" class="space-y-5">
            ...
            <div class="space-y-1.5">
                ...
                <textarea name="bio" id="bio" rows="6" class="panel-input" placeholder="Short instructor profile…">{{ old('bio') }}</textarea>
...
(function () {
    ...
    btn?.addEventListener('click', async function () {
        ...
        try {
            ...
            setStatus(json.message || 'Bio filled. Review and create the instructor.', false);
        } catch (err) {
