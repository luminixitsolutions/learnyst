    ...
    <div class="glass-card rounded-2xl p-6" id="live-class-form-fields"
        ...
        <form method="POST" action="{{ route('admin.live-classes.store') }}" class="space-y-5">
            ...
            <div class="space-y-1.5">
                ...
                <textarea name="description" id="description" rows="6" class="panel-input">{{ old('description') }}</textarea>
...
(function () {
    ...
    btn?.addEventListener('click', async function () {
        ...
        try {
            ...
            setStatus(json.message || 'Details filled. Add your real meeting link, then save.', false);
        } catch (err) {
