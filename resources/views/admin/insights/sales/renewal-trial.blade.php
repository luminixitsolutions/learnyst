        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm panel-table">
                <thead><tr class="text-left">
                    <th class="px-6 py-4">Learner</th><th class="px-6 py-4">Email</th><th class="px-6 py-4">Product</th>
                    <th class="px-6 py-4">Expiry Date</th><th class="px-6 py-4">Last Access</th><th class="px-6 py-4">Renewal Status</th>
                </tr></thead>
                <tbody>
