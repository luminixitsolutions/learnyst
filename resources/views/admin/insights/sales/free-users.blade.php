...
<div class="space-y-6">
    ...
    <div class="glass-card rounded-2xl overflow-hidden panel-datatable-wrapper">
        ...
        <div class="overflow-x-auto">
            <table id="freeUsersTable" class="w-full text-sm panel-table display" style="width:100%">
                <thead>
                    <tr class="text-left">
                        <th class="px-6 py-4">Learner</th>
                        <th class="px-6 py-4">Email</th>
                        <th class="px-6 py-4">Free Product</th>
                        <th class="px-6 py-4">Enrolled Date</th>
                        <th class="px-6 py-4">Last Access</th>
                        <th class="px-6 py-4">Upsell Status</th>
                    </tr>
                </thead>
                <tbody>
...
@push('scripts')
@if($records->count())
    <x-admin.datatable-scripts table-id="freeUsersTable" entity="free users" :order-column="3" order-direction="desc" export-file-name="free-users" />
@endif
@endpush
