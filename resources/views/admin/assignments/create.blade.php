    ...
    <div class="glass-card rounded-2xl p-6" id="assignment-form-fields"
        ...
        <form method="POST" action="{{ route('admin.assignments.store') }}" enctype="multipart/form-data" class="space-y-5">
            ...
            <div class="space-y-1.5">
                ...
                <textarea name="description" id="description" rows="8" class="panel-input">{{ old('description') }}</textarea>
...
(function () {
    ...
    btn?.addEventListener('click', async function () {
        ...
        try {
            ...
            setStatus(json.message || 'Details filled. Review and create the assignment.', false);
        } catch (err) {
