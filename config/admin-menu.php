    ...
    'admin' => [
        ...
        [
            ...
            'items' => [
                ...
                ['label' => 'Contacts', 'route' => 'admin.contacts.index', 'permission' => 'learners.view'],
                ['label' => 'Legal Documents', 'route' => 'admin.legal-documents.index', 'permission' => 'learners.view'],
            ],
        ],
        [
            'group' => 'Sales',
            ...
            'items' => [
                ...
                ['label' => 'Wallets', 'route' => 'admin.wallets.index', 'permission' => 'sales.view', 'active_routes' => [
                    'admin.wallets.*',
                ]],
                ['label' => 'Referrals', 'route' => 'admin.referrals.index', 'permission' => 'sales.view', 'active_routes' => [
                    'admin.referrals.*',
                ]],
                ['label' => 'Affiliates', 'route' => 'admin.affiliates.index', 'permission' => 'sales.view', 'active_routes' => [
                    'admin.affiliates.*',
                ]],
                ['label' => 'Subscriptions', 'route' => 'admin.subscriptions.plans', 'permission' => 'sales.view', 'active_routes' => [
                    'admin.subscriptions.*',
                ]],
                ['label' => 'GST Invoices', 'route' => 'admin.gst-invoices.index', 'permission' => 'sales.view', 'active_routes' => [
                    'admin.gst-invoices.*',
        ...
        [
            ...
            'items' => [
                ['label' => 'Campaigns', 'route' => 'admin.marketing.campaigns', 'permission' => 'sales.view', 'active_routes' => [
                    'admin.marketing.campaigns',
                    'admin.marketing.campaigns.*',
                ]],
                ['label' => 'Leads', 'route' => 'admin.marketing.leads', 'permission' => 'sales.view', 'active_routes' => [
                ...
                ['label' => 'Automations', 'route' => 'admin.automations.index', 'permission' => 'sales.view', 'active_routes' => [
                    'admin.automations.*',
                ]],
        ...
        [
            ...
            'items' => [
                ['label' => 'Pipeline', 'route' => 'admin.crm.pipeline', 'permission' => 'sales.view', 'active_routes' => ['admin.crm.pipeline']],
        ...
        [
            ...
            'items' => [
                ...
                ['label' => 'XP Rules', 'route' => 'admin.gamification.rules', 'permission' => 'products.view', 'active_routes' => [
        ...
        [
            ...
            'items' => [
                ['label' => 'Dashboard', 'route' => 'admin.finance.dashboard', 'permission' => 'sales.view', 'active_routes' => ['admin.finance.dashboard']],
        ...
        [
            ...
            'icon' => 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z',
            'items' => [
                ['label' => 'Employees', 'route' => 'admin.hr.employees', 'permission' => 'learners.view', 'active_routes' => ['admin.hr.employees*']],
        ...
        [
            ...
            'items' => [
                ['label' => 'Branches', 'route' => 'admin.branches.index', 'permission' => 'settings.view', 'active_routes' => ['admin.branches.index', 'admin.branches.show']],
        ...
        [
            ...
            'items' => [
                ['label' => 'Recruiters', 'route' => 'admin.placements.companies', 'permission' => 'learners.view', 'active_routes' => ['admin.placements.companies*']],
        ...
        [
            ...
            'icon' => 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253',
            'items' => [
                ['label' => 'Library Manager', 'route' => 'admin.library.index', 'permission' => 'products.view', 'active_routes' => ['admin.library.*']],
            ],
        ],
        [
            'group' => 'Settings',
            ...
            'items' => [
                ...
                ['label' => 'White Label (Web)', 'route' => 'admin.whitelabel.edit', 'permission' => 'settings.view', 'active_routes' => [
                    'admin.whitelabel.*',
                ]],
            ],
        ],
        [
            ...
            'items' => [
                ['label' => 'AI Center', 'route' => 'admin.ai.index', 'permission' => 'products.view', 'active_routes' => [
                    'admin.ai.*',
                ]],
            ],
        ],
        [
            ...
            'items' => [
                ['label' => 'Integrations', 'route' => 'admin.integrations.index', 'permission' => 'settings.view', 'active_routes' => [
                    'admin.integrations.*',
                ]],
